...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#0F0F0F" :foreground "#A59461"))))
 '(blue ((t (:foreground "blue"))))
 '(bold ((t (:bold t))))
 '(bold-italic ((t (:bold t :slant italic))))
 '(border-glyph ((t (nil))))
 '(buffers-tab ((t (:background "#0F0F0F" :foreground "#A59461"))))
 ...
 '(highline-face ((t (:background "#B45B00" :foreground "#FFF"))))
 '(italic ((t (nil))))
 '(left-margin ((t (nil))))
 '(mmm-default-submode-face ((t (:background "#111"))))
 '(mode-line ((t (:background "#0C0C0C" :foreground "#B45B00"))))
 '(primary-selection ((t (:background "#222"))))
;; '(region ((t (:background "#322a2c"))))
 '(region ((t (:background "#B45B00" :foreground "#0F0F0F"))))
 '(text-cursor ((t (:background "#B45B00" :foreground "#FFFFFF"))))
 '(underline ((nil (:underline nil))))
)

(provide-theme 'zunder)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; zunder-theme.el  ends here
